...
declare -gA THEME_COLORS=(
    ...
    [session-prefix-bg]="#f1b467" # Prefix mode (yellow)
    [session-copy-bg]="#505050"   # Copy mode (cyan)

    # Windows
    [window-active-base]="#87a6c4"   # Active window (teal)
    ...
    [info-base]="#87a6c4"         # Info (teal)
    [warning-base]="#f1b467"      # Warning (yellow)
    [error-base]="#87a6c4"        # Error (red)
