...
POWERKIT_DEFAULT_HELPER_KEY="C-/"    # prefix + Ctrl+/ (help)
POWERKIT_DEFAULT_HELPER_WIDTH="80%"
POWERKIT_DEFAULT_HELPER_HEIGHT="80%"
POWERKIT_DEFAULT_OPTIONS_KEY="C-e"   # prefix + Ctrl+e (options/Edit)
POWERKIT_DEFAULT_OPTIONS_WIDTH="80%"
POWERKIT_DEFAULT_OPTIONS_HEIGHT="80%"
POWERKIT_DEFAULT_KEYBINDINGS_KEY="C-g"  # prefix + Ctrl+g (Get bindings)
...
POWERKIT_PLUGIN_AUDIODEVICES_INPUT_KEY="C-i"   # prefix + Ctrl+i (Input audio)
POWERKIT_PLUGIN_AUDIODEVICES_OUTPUT_KEY="C-s"  # prefix + Ctrl+s (Sound/speaker)
...
POWERKIT_PLUGIN_KUBERNETES_CONTEXT_SELECTOR_KEY="C-q"   # prefix + Ctrl+q (k8s context)
POWERKIT_PLUGIN_KUBERNETES_CONTEXT_SELECTOR_WIDTH="50%"
POWERKIT_PLUGIN_KUBERNETES_CONTEXT_SELECTOR_HEIGHT="50%"
POWERKIT_PLUGIN_KUBERNETES_NAMESPACE_SELECTOR_KEY="C-w"  # prefix + Ctrl+w (k8s namespace)
...
POWERKIT_PLUGIN_TERRAFORM_WORKSPACE_KEY="C-t"  # prefix + Ctrl+t (Terraform)
...
# Cache
POWERKIT_PLUGIN_CACHE_CLEAR_KEY="C-x"  # prefix + Ctrl+x (eXpunge/clear cache)
